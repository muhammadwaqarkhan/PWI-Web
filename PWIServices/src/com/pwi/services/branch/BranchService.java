...
public class BranchService extends ServiceBase {
	 ...
	 * 
	 * @param BranchDTO
	 *            which contain branch information + branch address
	 * 
	 * @return IResponseHandler to check either request completed successfully
	 *         or not
	 */
	 ...
	 * 
	 * @param BranchDTO
	 *            information which required to delete
	 * 
	 * @return IResponseHandler to check either record deleted successfully or
	 *         not
	 */
	 ...
	 * 
	 * @param BranchDTO
	 *            information which required to update
	 * 
	 * @return IResponseHandler to check either record deleted successfully or
	 *         not
	 */
