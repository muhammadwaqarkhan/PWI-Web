...
/**
 * This utility is responsible for providing interface to initiate calls to
 * different services. Basic purpose of introducing it is to provide a one entry
 * point for all services so that we know from where a service is initiated and
 * we can handle exceptions/errors better. This way we will allow a user to
...
public class ServiceExecutor {
	...
	/***
	 * This method is responsible for open Hibernate session and management
	 * transaction in case of ant exception this method will roll-back persist
	 * entity and close connection
	 * 
	 * @param ServiceBase
	 *            every service must extent which ServiceBase service
	 *            serviceName: string parameter which contains serviceMethod
	 *            name inDTO: this is type of IRequestHadnler, which contain
	 *            input information
	...
	/***
	 * @Transactional:This method is responsible for transaction management in
	 *                     case of any exception this method will roll-back
	 *                     persist entity and close connection
	 * @param SpringServiceBase
	 *            every service must extent which SpringServiceBase service
	 *            serviceName: string parameter which contains serviceMethod
	 *            name inDTO: this is type of IRequestHadnler, which contain
	 *            input information
	 * @return Object any type of object
	...
	/***
	 * ServiceBase method is responsible to find those service method which have
	 * annotation of ServiceMethod
	 * 
	 * @param ServiceBase
	 *            instance of service to find method serviceName: string
	 *            parameter which contains serviceMethod name
	 * 
	...
	/***
	 * SpringServiceBase method is responsible to find those service method
	 * which have annotation of ServiceMethod
	 * 
	 * @param ServiceBase
	 *            instance of service to find method serviceName: string
	 *            parameter which contains serviceMethod name
