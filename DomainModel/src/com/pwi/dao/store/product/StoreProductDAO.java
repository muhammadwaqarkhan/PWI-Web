...
public class StoreProductDAO extends BaseDAO implements IStoreProductDAO {
	...
	public static StoreProductDAO getInstance(Session session) {
		StoreProductDAO dao = (StoreProductDAO) SpringApplicationContext.getApplicationContext().getBean(
				"storeProductDAO");
		dao.init(session);
		return dao;
	}
	...
	public StoreProduct findByPrimaryKey(Long storeProductID) {
		// String hql =
		// "from StoreProduct where storeProductID=:storeProductID";
	...
	public List<StoreProduct> readByStoreIDProductID(Long productID, Long storeID) {
		// String hql =
		// "from StoreProduct where productID=:productID and storeID=:storeID";
