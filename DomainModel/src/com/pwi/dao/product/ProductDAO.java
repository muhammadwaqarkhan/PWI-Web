...
public class ProductDAO extends BaseDAO implements IProductDAO {
	...
	public Product findByPrimaryKey(Long productID) {
		...
		// String hql =
		// "from com.pwi.domain.product.Product where productID=:productID";
	 ...
	 * 
	 * @param Integer
	 *            : size of product String: name of product String type of
	 *            product
	 * 
	 * @return Product
	 */
	...
	public Product readBySizeNameAndType(Integer size, String name, String type) {
		// String hql =
		// "from com.pwi.domain.product.Product where  productName=:productName and size=:size and productType=:productType";
	...
	public List<Product> readByName(String name) {
		// String hql =
		// "from com.pwi.domain.product.Product where  productName=:productName ";
